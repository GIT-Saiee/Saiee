...
const bubblespecs = [
  ...
  { s: .6, x: 700,  y: 226, name: "greenhouse", desc: "Green House to keep Saplings"  },
  ...
  { s: .8, x: 163,  y: 4, name: "mirchi", desc: "Peppers from garden"  },
  { s: .8, x: 323,  y: 60, name: "pom", desc: "Pomegrante broken as it riped on the tree itself"   },
