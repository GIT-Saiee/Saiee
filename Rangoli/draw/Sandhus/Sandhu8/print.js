...
document.getElementById('printBookButton').addEventListener('click', function() {
   ...
   // console.log(pageElements);
    ...
    printableHTML += '</div>';
    const pageElements=['images/color2.png','images/final_star_dot.png','images/final_star_explain.png','images/0.png', 'images/1.png','images/2.png','images/3.png', 'images/4.png','images/5.png','images/6.png','images/7.png','images/8.png','images/c0.png', 'images/c1.png','images/c2.png','images/c3.png', 'images/c4.png','images/c5.png','images/star1.png','images/color1.png','images/color2.png']
